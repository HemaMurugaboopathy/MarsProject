...
namespace Mars.Pages
{
    ...
    {
        public void Create_LanguagePage(IWebDriver driver)
        {
            ...
            IWebElement addTextbox = driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/div/div[1]/input"));
            addTextbox.SendKeys("English");

            //Click dropdown icon to select level
            IWebElement element = driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/div/div[2]/select"));
            element.Click();
            Thread.Sleep(2000);

            //Choose level to be selected
            IWebElement selectlevelOption = driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/div/div[2]/select/option[2]"));
        ...
        public void Edit_LanguagePage(IWebDriver driver)
        {
            //Click edit icon 
        ...
        public void Delete_LanguagePage(IWebDriver driver)
        {
            //Delete the language
